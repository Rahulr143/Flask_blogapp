...
from flaskblog.form import (RegisterFrom,LoginFrom,UpdationFrom,PostForm,RequestResetForm,ResetPasswordForm)
...
def login():
    ...
    if form.validate_on_submit():
            ...
            if user and bcrypt.check_password_hash(user.password,form.password.data):
                ...
                flash(f"Loggin UnSuccessfull please check email and password",'danger')
...
def send_reset_email(user):
    ...
    If you did not make this request then simply ingnore this email and no changes.
    '''
...
def reset_request():
    ...
    if form.validate_on_submit():
        ...
        flash('An email with instruction to reset password check your mail','info')
